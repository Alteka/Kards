  ...
  computed: {
    ...
    computedRamp1: function () {
      ...
      if (this.config.ramp.direction == 'Radial') {
        ...
        result = {
          background: 'linear-gradient(' + this.gradientAngle + 'deg, ' + this.computedColours + ')'
        }
      }
    ...
    computedRamp2: function () {
      ...
      if (this.config.ramp.direction == 'Radial') {
        ...
        result = {
          background:
            'linear-gradient(' + (this.gradientAngle - 180) + 'deg, ' + this.computedColours + ')'
        }
      }
    ...
    showSteps: function () {
      if (this.config.ramp.stepped) {
        if (
          this.config.ramp.direction == 'Horizontal' ||
          this.config.ramp.direction == 'Vertical'
        ) {
          return true
        } else {
          return false
