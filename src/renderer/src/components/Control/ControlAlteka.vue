<template>
  <div>
    <el-row>
      ...
      <el-col :span="6">
        <el-form-item label="Center Text" label-width="100">
          <el-color-picker
            v-model="alteka.textColour"
            :disabled="!alteka.showLogo"
            :predefine="colors"
          ></el-color-picker>
        </el-form-item>
      </el-col>
    ...
    <el-row>
      ...
      <el-col v-if="alteka.showLogo" :span="9">
        <el-button-group>
          <el-tooltip
            effect="dark"
            content="Image will be masked to 3:1 aspect ratio"
            placement="bottom"
            :open-delay="500"
          >
            <el-button size="small" @click="selectImage"
              ><i class="far fa-image"></i> Select Image</el-button
            >
          </el-tooltip>
          <el-button size="small" @click="clearImage">Clear</el-button>
        </el-button-group>
      </el-col>
