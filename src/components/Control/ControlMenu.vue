    ...
    <el-col :span="8" style="text-align: right">
      <el-dropdown size="mini" :hide-on-click="false" @visible-change="handleMoreMenuChange">
        ...
        <el-dropdown-menu>
          ...
          <el-dropdown-item :disabled="config.cardType!='bars' && config.cardType!='ramp' && config.cardType != 'grid'" divided v-if="config.infoCircleAnimated" @click="config.infoCircleAnimated = false"><i class="fa-solid fa-circle-info green" style="width: 10px; text-align: center;"></i> Static Info Circle</el-dropdown-item>
          <el-dropdown-item :disabled="config.cardType!='bars' && config.cardType!='ramp' && config.cardType != 'grid'" divided v-if="!config.infoCircleAnimated" @click="config.infoCircleAnimated = true"><i class="fa-solid fa-circle-info green" style="width: 10px; text-align: center;"></i> Animate Info Circle</el-dropdown-item>
