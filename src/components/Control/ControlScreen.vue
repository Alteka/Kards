  ...
  <div> 
    <svg :view-box.camel="viewBox" style="width: 90%; margin-left: 5%; margin-top: 10px; height: 125px;">
      <g v-for="scr in screens" :key="scr.id" v-on:click="selectScreen(scr.id)">
        ...
        <text v-if="!scr.portrait" :x="scr.bounds.x + scr.bounds.width/2" :y="scr.bounds.y + scr.bounds.height/1.05" :width="scr.bounds.width" :height="scr.bounds.height" font-family="Verdana" :font-size="scr.bounds.height/8" text-anchor="middle" fill="white">{{ scr.displayFrequency }}Hz</text>
