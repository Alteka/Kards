...
export default {
  ...
  mounted: function(){
    ...
    Mousetrap.bind(['4'], function() { vm.config.cardType = 'ramp'; return false; })
    Mousetrap.bind(['5'], function() { vm.config.cardType = 'placeholder'; return false; })
    Mousetrap.bind(['6'], function() { vm.config.cardType = 'audioSync'; return false; })
    Mousetrap.bind(['7'], function() { vm.config.cardType = 'deghost'; return false; })
    Mousetrap.bind(['8'], function() { vm.config.cardType = 'led'; return false; })
  },
  watch: {
    config: {
